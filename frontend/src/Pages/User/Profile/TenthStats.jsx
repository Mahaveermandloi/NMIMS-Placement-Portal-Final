  ...
  const onSubmit = async (data) => {
    ...
    try {
      const response = await putApi(
        payload,
        `${SERVER_URL}/api/updatetenthdetails`
      );
              ...
              <div className="grid lg:grid-cols-2 gap-4 h-96 overflow-y-scroll">
                ...
                <label>
                  ...
                  <input
                    ...
                    {...register("year_of_passing_twelfth", {
                      ...
                      max: {
                        value: new Date().getFullYear() - 5, // Ensures it's no more than 5 years less than the current year
                ...
                <label>
                  ...
                  <p className="text-gray-400">
                    Upload the Class X Marksheet (PDF only)
                  </p>
