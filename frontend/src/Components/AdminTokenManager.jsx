...
import { SERVER_URL, ADMIN_PATH, STUDENT_PATH } from "../Utils/URLPath";
...
export const AdminTokenManager = () => {
  ...
  const refreshAccessToken = async () => {
    ...
    try {
      const response = await getApi(`${SERVER_URL}/api/admin/refresh-token`, {
...
export const removeTokensAndRedirectForAdminRoutes = (navigate) => {
  localStorage.clear();
